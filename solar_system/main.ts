namespace Solarsystem {
    ...
    function hndSliderInput(): void {
        const value: number = Number(speedSlider.value) / 5;
        rotationspeed = value;
    }
    ...
    const sun: CelestialBodies = new CelestialBodies("Sun", "yellow", 30, 0, 0, planets); //create all bodies (sun, planets and moons) and push them in their respective arrays

    const mercury: Body = new CelestialBodies("Mercury", "gainsboro", 3, 0.26, 55, empty);
